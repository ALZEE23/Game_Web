...
export default function Landing() {
  return (
    <>
      ...
      <section>
        <div className="bg-[#21201F] relative  px-40 p-10 pb-32">
          <div className="absolute right-[7.7rem] top-28">
          ...
          <h1 className="font-semibold font-staatliches text-10xl tracking-tight text-[#FAF4ED]">
            PPLG
          </h1>
          <div className="pr-96 ">
      ...
      <section>
        <div className="px-40 h-80 bg-[#FAF4ED]">
            ...
            <div className="mt-8">
              ...
              <div className="flex justify-between">
                <div className="w-[25%]">
                  ...
                  <h1 className="font-staatliches">Email: smkn1_ciomas@yahoo.co.id</h1>
                </div>
                <div>
